...
- gea -> sra-run           (SDRF の Comment[SRA_RUN] から、CP2 会話 4 で追加)
- gea -> sra-experiment    (SDRF の Comment[SRA_EXPERIMENT] から、CP2 会話 4 で追加)
- gea -> jga-study         (IDF の Comment[Related study] の JGA:JGAS* から、CP2 会話 4 で追加)
- gea -> humandbs          (IDF の Comment[Related study] の NBDC:hum* から、CP2 会話 4 で追加)

Metabolonote / RPMM / Metabolights / 不明 prefix は silent skip + log_debug で観測可能化
(cp0-history §3-7 決定、es-field-design §3.5.4)。
"""
