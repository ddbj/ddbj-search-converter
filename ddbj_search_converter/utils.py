...
URL_TEMPLATE: Dict[XrefType, str] = {
    ...
    "sra-submission": "https://ddbj.nig.ac.jp/resource/sra-submission/{id}",
    ...
    "sra-analysis": "https://ddbj.nig.ac.jp/resource/sra-analysis/{id}",
    "jga-study": "https://ddbj.nig.ac.jp/resource/jga-study/{id}",
    "jga-dataset": "https://ddbj.nig.ac.jp/resource/jga-dataset/{id}",
    "jga-dac": "https://ddbj.nig.ac.jp/resource/jga-dac/{id}",
    "jga-policy": "https://ddbj.nig.ac.jp/resource/jga-policy/{id}",
