...
EXPORT_RELATIONS: list[tuple[AccessionType, AccessionType, str]] = [
    ...
    ("bioproject", "humandbs", "bioproject-humID/bioproject2humID.tsv"),
    ...
    ("jga-study", "humandbs", "jga_study-humID/jga_study2humID.tsv"),
    ("jga-dataset", "humandbs", "jga_dataset-humID/jga_dataset2humID.tsv"),
    ("jga-study", "pubmed", "jga_study-pubmed_id/jga_study2pubmed_id.tsv"),
