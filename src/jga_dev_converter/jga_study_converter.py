    ...
    for events, element in context:
        if element.tag == "STUDY":
            ...
            doc["dbXrefs"] = [
                ...
                {
                    "identifier": "JGAD000859",
                    "type": "jga-dataset",
                    "url": "https://ddbj.nig.ac.jp/resource/jga-dataset/JGAD000859"
                }
...
def dict2jsonl(docs: List[dict]):
    jsonl_output = "jga-study_JGAS000726.jsonl"
...
if __name__ == "__main__":
    input = "/mnt/data/ddbj/jga-adhoc/JGAS000726.xml"
    docs = xml2json(input)
    dict2jsonl(docs)
